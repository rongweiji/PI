...
- You can choose the calibration resolution from the segmented control: default `1920×1440`, `1920×1080`, or `640×480`. The app reconfigures the capture session to that preset and shows the actual frame dimensions it is calibrating against.
